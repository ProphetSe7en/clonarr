...
func (s *Server) registerRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/instances/{id}/naming/auto-sync", s.handleGetNamingAutoSync)
	...
	mux.HandleFunc("GET /api/instances/{id}/naming/changes", s.handleGetNamingChanges)
	mux.HandleFunc("POST /api/instances/{id}/naming/restore-field", s.handleRestoreNamingField)
	...
	mux.HandleFunc("GET /api/trash/{app}/profiles/descriptions", s.handleTrashProfileDescriptions)
